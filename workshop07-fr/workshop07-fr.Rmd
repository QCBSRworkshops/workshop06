...
Le jeu de données chargé contient une partie du jeu de données classique des [mites Oribatid](http://adn.biol.umontreal.ca/~numericalecology/data/oribates.html):
...
<br>
Ce qui signifie que $y_i$ (réalisation de $Y_i$) est échantillonnée dans une distribution normale ayant les paramètres $\mu$ (dont la valeur dépend de $x_i$) et $\sigma$ (indépendantes de $x_i$)
...
- Les statisticiens ont développé [une foule de lois de probabilité (distributions)](https://www.causascientia.org/math_stat/Dists/Compendium.pdf) correspondant à divers types de données
