...
1. Ces graphiques permettes de vérifier les conditions d'application de la linéarité et l'homoscédasticité.
...
```
???
Ces relations sont tous des relations linéaires potentielles, mais le contenu en eau a le plus de potentiel d'être significatif (les boîtes ne se touchent pas)
