...
<br>
This workshop will build up your knowledge on models along side with some of their important equations. *Do not run to the mountains!* This will be achieve progressively and you will feel proud of yourself after!
...
$$Y = f(X_1, \epsilon)$$
--
In [Workshop 4](), we have learned how to use **general linear models** as $f(\cdot)$ to describe the relationship between variables. They were:
...
In [Workshop 4](), we have learned how to use **general linear models** as $f(\cdot)$ to describe the relationship between variables.
...
They look very bad for `lm(prop ~ WaterCont)`:
...
We have been told to **transform** our data using logarithmic, square-root, and consine transformations.
...
---
# Plus, normal distributions are not the only ones!

Statisticians have described a multitude of distributions to describe different types of data.
