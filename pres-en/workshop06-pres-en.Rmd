...
---
# Normal distributions are not the only options!

Statisticians have described a [multitude of distributions](https://www.causascientia.org/math_stat/Dists/Compendium.pdf) to describe different types of data.
...
---
# Modelling with other distributions
...
$$\eta_i = \underbrace{g(\mu_i)}_{Link~~function}  = \underbrace{\beta_0 + \beta_1X_1~+~...~+~\beta_pX_p}_{Linear~component}$$
and,
