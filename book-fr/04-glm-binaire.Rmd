...
la semaine de test (`week`). Commencez avec un modèle saturé et
...
où \<m\>overline{π}\_1\</m\> est la moyenne attendue des probabilités
...
obtenir la valeur de *D* et comment représenter visuellement les valeurs
de \<m\>overline{π}\_1\</m\> et \<m\>overline{π}\_0\</m\>.
